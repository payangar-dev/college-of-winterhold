...
@OnlyIn(Dist.CLIENT)
public class FireMasterRenderer extends AbstractSpellCastingMobRenderer {
    public FireMasterRenderer(EntityRendererProvider.Context context) {
        super(context, new FireMasterModel());
