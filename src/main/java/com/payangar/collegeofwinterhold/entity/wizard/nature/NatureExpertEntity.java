...
public class NatureExpertEntity extends AbstractCollegeWizardEntity {
    public NatureExpertEntity(EntityType<? extends AbstractSpellCastingMob> type, Level level) {
        super(type, level);
    }
