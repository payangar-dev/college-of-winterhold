...
@OnlyIn(Dist.CLIENT)
public class EnderApprenticeRenderer extends AbstractSpellCastingMobRenderer {
    public EnderApprenticeRenderer(EntityRendererProvider.Context context) {
        super(context, new EnderApprenticeModel());
