...
@OnlyIn(Dist.CLIENT)
public class NatureNoviceRenderer extends AbstractSpellCastingMobRenderer {
    public NatureNoviceRenderer(EntityRendererProvider.Context context) {
        super(context, new NatureNoviceModel());
