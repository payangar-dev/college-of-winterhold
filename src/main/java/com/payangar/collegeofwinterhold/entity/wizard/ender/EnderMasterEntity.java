...
public class EnderMasterEntity extends AbstractCollegeWizardEntity {
    public EnderMasterEntity(EntityType<? extends AbstractSpellCastingMob> type, Level level) {
        super(type, level);
    }
