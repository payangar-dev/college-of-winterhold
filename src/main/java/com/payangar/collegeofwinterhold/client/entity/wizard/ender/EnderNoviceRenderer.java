...
@OnlyIn(Dist.CLIENT)
public class EnderNoviceRenderer extends AbstractSpellCastingMobRenderer {
    public EnderNoviceRenderer(EntityRendererProvider.Context context) {
        super(context, new EnderNoviceModel());
