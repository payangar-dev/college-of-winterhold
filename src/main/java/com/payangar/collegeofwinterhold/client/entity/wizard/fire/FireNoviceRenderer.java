...
@OnlyIn(Dist.CLIENT)
public class FireNoviceRenderer extends AbstractSpellCastingMobRenderer {
    public FireNoviceRenderer(EntityRendererProvider.Context context) {
        super(context, new FireNoviceModel());
