...
public class NatureNoviceEntity extends AbstractCollegeWizardEntity {
    public NatureNoviceEntity(EntityType<? extends AbstractSpellCastingMob> type, Level level) {
        super(type, level);
    }
