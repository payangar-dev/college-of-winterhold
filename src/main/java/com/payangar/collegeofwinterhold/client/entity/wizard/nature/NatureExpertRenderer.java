...
@OnlyIn(Dist.CLIENT)
public class NatureExpertRenderer extends AbstractSpellCastingMobRenderer {
    public NatureExpertRenderer(EntityRendererProvider.Context context) {
        super(context, new NatureExpertModel());
