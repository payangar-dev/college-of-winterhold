...
public class EnderExpertEntity extends AbstractCollegeWizardEntity {
    public EnderExpertEntity(EntityType<? extends AbstractSpellCastingMob> type, Level level) {
        super(type, level);
    }
