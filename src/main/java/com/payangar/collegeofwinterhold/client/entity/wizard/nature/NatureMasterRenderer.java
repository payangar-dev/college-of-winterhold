...
@OnlyIn(Dist.CLIENT)
public class NatureMasterRenderer extends AbstractSpellCastingMobRenderer {
    public NatureMasterRenderer(EntityRendererProvider.Context context) {
        super(context, new NatureMasterModel());
