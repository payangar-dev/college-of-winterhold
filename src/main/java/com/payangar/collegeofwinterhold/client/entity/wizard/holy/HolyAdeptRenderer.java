...
@OnlyIn(Dist.CLIENT)
public class HolyAdeptRenderer extends AbstractSpellCastingMobRenderer {
    public HolyAdeptRenderer(EntityRendererProvider.Context context) {
        super(context, new HolyAdeptModel());
