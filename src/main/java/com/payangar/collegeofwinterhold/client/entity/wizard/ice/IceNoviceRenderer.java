...
@OnlyIn(Dist.CLIENT)
public class IceNoviceRenderer extends AbstractSpellCastingMobRenderer {
    public IceNoviceRenderer(EntityRendererProvider.Context context) {
        super(context, new IceNoviceModel());
