...
public class IceApprenticeEntity extends AbstractCollegeWizardEntity {
    public IceApprenticeEntity(EntityType<? extends AbstractSpellCastingMob> type, Level level) {
        super(type, level);
    }
