...
@OnlyIn(Dist.CLIENT)
public class IceExpertRenderer extends AbstractSpellCastingMobRenderer {
    public IceExpertRenderer(EntityRendererProvider.Context context) {
        super(context, new IceExpertModel());
