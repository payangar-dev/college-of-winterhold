...
@OnlyIn(Dist.CLIENT)
public class LightningExpertRenderer extends AbstractSpellCastingMobRenderer {
    public LightningExpertRenderer(EntityRendererProvider.Context context) {
        super(context, new LightningExpertModel());
