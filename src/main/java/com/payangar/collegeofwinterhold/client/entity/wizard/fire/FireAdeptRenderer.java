...
@OnlyIn(Dist.CLIENT)
public class FireAdeptRenderer extends AbstractSpellCastingMobRenderer {
    public FireAdeptRenderer(EntityRendererProvider.Context context) {
        super(context, new FireAdeptModel());
