...
@OnlyIn(Dist.CLIENT)
public class HolyApprenticeRenderer extends AbstractSpellCastingMobRenderer {
    public HolyApprenticeRenderer(EntityRendererProvider.Context context) {
        super(context, new HolyApprenticeModel());
