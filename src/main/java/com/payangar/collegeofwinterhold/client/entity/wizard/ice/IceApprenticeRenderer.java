...
@OnlyIn(Dist.CLIENT)
public class IceApprenticeRenderer extends AbstractSpellCastingMobRenderer {
    public IceApprenticeRenderer(EntityRendererProvider.Context context) {
        super(context, new IceApprenticeModel());
