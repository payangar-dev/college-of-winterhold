...
@OnlyIn(Dist.CLIENT)
public class LightningNoviceRenderer extends AbstractSpellCastingMobRenderer {
    public LightningNoviceRenderer(EntityRendererProvider.Context context) {
        super(context, new LightningNoviceModel());
