...
@OnlyIn(Dist.CLIENT)
public class HolyNoviceRenderer extends AbstractSpellCastingMobRenderer {
    public HolyNoviceRenderer(EntityRendererProvider.Context context) {
        super(context, new HolyNoviceModel());
