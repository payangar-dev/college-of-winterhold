...
@OnlyIn(Dist.CLIENT)
public class FireApprenticeRenderer extends AbstractSpellCastingMobRenderer {
    public FireApprenticeRenderer(EntityRendererProvider.Context context) {
        super(context, new FireApprenticeModel());
