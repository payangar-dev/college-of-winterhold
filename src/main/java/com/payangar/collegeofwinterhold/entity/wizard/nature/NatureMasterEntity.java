...
public class NatureMasterEntity extends AbstractCollegeWizardEntity {
    public NatureMasterEntity(EntityType<? extends AbstractSpellCastingMob> type, Level level) {
        super(type, level);
    }
