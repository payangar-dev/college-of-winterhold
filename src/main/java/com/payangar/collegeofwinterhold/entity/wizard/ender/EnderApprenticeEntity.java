...
public class EnderApprenticeEntity extends AbstractCollegeWizardEntity {
    public EnderApprenticeEntity(EntityType<? extends AbstractSpellCastingMob> type, Level level) {
        super(type, level);
    }
