...
public class NatureAdeptEntity extends AbstractCollegeWizardEntity {
    public NatureAdeptEntity(EntityType<? extends AbstractSpellCastingMob> type, Level level) {
        super(type, level);
    }
