...
@OnlyIn(Dist.CLIENT)
public class HolyExpertRenderer extends AbstractSpellCastingMobRenderer {
    public HolyExpertRenderer(EntityRendererProvider.Context context) {
        super(context, new HolyExpertModel());
