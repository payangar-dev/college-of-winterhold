...
@OnlyIn(Dist.CLIENT)
public class LightningAdeptRenderer extends AbstractSpellCastingMobRenderer {
    public LightningAdeptRenderer(EntityRendererProvider.Context context) {
        super(context, new LightningAdeptModel());
