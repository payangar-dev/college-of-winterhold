...
public class HolyApprenticeEntity extends AbstractCollegeWizardEntity {
    public HolyApprenticeEntity(EntityType<? extends AbstractSpellCastingMob> type, Level level) {
        super(type, level);
    }
